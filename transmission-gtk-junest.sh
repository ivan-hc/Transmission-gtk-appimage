...
DEPENDENCES="ca-certificates curl hicolor-icon-theme libb64 libdeflate libevent libnatpmp miniupnpc"
...
BINSAVED="certificates curl" # Enter here keywords to find and save in /usr/bin
SHARESAVED="certificates gtk" # Enter here keywords or file/folder names to save in both /usr/share and /usr/lib
LIBSAVED="pk p11 curl gtk proxy" # Enter here keywords or file/folder names to save in /usr/lib
