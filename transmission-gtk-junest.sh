...
DEPENDENCES="curl hicolor-icon-theme libb64 libdeflate libevent libnatpmp miniupnpc"
...
_binlibs(){
	...
	SHARESAVED="certificates gtk" # Enter here keywords or file/folder names to save in /usr/lib. By default, the names of the folders that you will save in /usr/share are selected also here.
...
_libkeywords(){
	LIBSAVED="curl gtk proxy" # Enter here keywords or file/folder names to save in /usr/lib.
